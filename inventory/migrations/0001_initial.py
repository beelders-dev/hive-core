# Generated by Django 6.0.4 on 2026-08-07 15:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('low_stock_threshold', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0'), message='Stock threshold cannot be negative.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qty_purchased', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'), message='Purchased quantity must be at least 0.01.')])),
                ('qty_remaining', models.DecimalField(decimal_places=2, max_digits=10)),
                ('total_cost', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'), message='Total cost must be at least 0.01.')])),

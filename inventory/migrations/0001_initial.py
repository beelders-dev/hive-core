# Generated by Django 6.0.4 on 2026-04-30 21:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_requirements', to='inventory.recipe')),
            ],
        ),
        migrations.AddField(
            model_name='recipe',
